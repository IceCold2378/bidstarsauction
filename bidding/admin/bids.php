							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										...
										<span class="badge badge-success">Bid Won</span>
										<?php else: ?>
										<span class="badge badge-secondary">Bid Lost</span>
										<?php endif; ?>
										<?php endif; ?>
									...
									<td>
										<button class="btn btn-primary btn-sm view_user" type="button" data-id ='<?php echo $row['user_id'] ?>'>View Bidder Details</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
